...
<!-- Start Features-->
<div class="our-features-area bg-cover default-padding shadow dark text-light MyAboutShadow" style="background-image: url(assets/img/blog4.jpg);">
    <div class="container">
        <div class="row">
            <!-- Single Item -->
                ...
                <div class="col-lg-4 col-md-4 single-item">
                    <div class="pricing-item">
                        <ul>
                            ...
                            <li class="footer">
                                <a class="btn MyBtn border btn-sm" href="contact.php">Select</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 single-item">
                    <div class="pricing-item active">
                        <ul>
                            ...
                            <li class="footer">
                                <a class="btn MyBtn effect btn-sm" href="contact.php">Select</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="services-items">
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item MyItem1">
                        <div class="icon">
                            <img src="assets/img/branding.png" class="ServiceIcon" />
                        </div>
                        <h4><a href="service.php?id=brand" style="color:white;">Brand Development & Strategy</a></h4>
                        <p style="color:white;">
                            Your brand is more than just a logo—it's the story, vision, and values that connect you with your audience.
                            We craft compelling brand identities that stand out, combining unique visual elements and comprehensive strategies
                            to resonate with your target audience and drive loyalty.
                        </p>
                        <a href="service.php?id=brand">Learn More</a>
                    </div>
                </div>
                <!-- End Single Item -->
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item MyItem1">
                        <div class="icon">
                            <img src="assets/img/design.png" class="ServiceIcon" />
                        </div>
                        <h4><a href="service.php?id=graphic" style="color:white;">Graphic Design</a></h4>
                        <p style="color:white;">
                            We create visually stunning designs that effectively communicate your brand's story. From logos and brochures
                            to social media graphics and advertising materials, our designs blend creativity and strategy to captivate and leave a lasting impression.
                        </p>
                        <a href="service.php?id=graphic">Learn More</a>
                    </div>
                </div>
                <!-- End Single Item -->
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item MyItem1">
                        <div class="icon">
                            <img src="assets/img/sms.png" class="ServiceIcon" />
                        </div>
                        <h4><a href="service.php?id=sms" style="color:white;">SMS Marketing</a></h4>
                        <p style="color:white;">
                            Reach your audience directly with our SMS marketing solutions. We craft personalized and impactful messages
                            to promote your offers, updates, and campaigns, ensuring high engagement rates and boosting conversions.
                        </p>
                        <a href="service.php?id=sms">Learn More</a>
                    </div>
                </div>
                <!-- End Single Item -->
